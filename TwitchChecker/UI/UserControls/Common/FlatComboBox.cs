	...
	public class FlatComboBox : ComboBox
	{
		...
		private void PaintFlatControlBorder(Control ctrl, Graphics g)
		{
			...
			if (ctrl.Focused == false || ctrl.Enabled == false)
				...
				ControlPaint.DrawBorder(g, rect, SkinManager.Instance.ColorProvider.ContextMenuBorder, ButtonBorderStyle.Solid);
		}
